export function addSearchAndAccordion() {
  const main = document.querySelector('main');
  if (!main) return;

  // Перевіряємо: чи вже є акордеон або пошук
  if (document.querySelector('.fixed-accordion') || document.querySelector('#search')) {
    return; // вже є — виходимо
  }
